        ...
        <div className="col-span-1 column bg-darkCyan rounded-2xl px-9 flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 mt-12 items-center">
              ...
              <p className="col-span-1 flex justify-end text-5xl text-cyan">$0.00</p>
            </div>
          ...
          <div className="mb-10 resetBtn rounded-sm text-center cursor-pointer hover:bg-cyan hover:text-darkCyan">
            <button className="text-xl py-1.5">
              RESET
            </button>
          </div>
